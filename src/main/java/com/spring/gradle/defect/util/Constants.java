...
public class Constants {
    ...
    public static final String CREATEDEFECT = "/create";
    public static final String GET_DEFECT = "/get/{id}";
    public static final String GET_ALLDEFECT = "/getAll";
    public static final String PUT_DEFECT = "/update/{id}";
    public static final String DELE_DEFECT = "/delete/{id}";
